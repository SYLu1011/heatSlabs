...
function siRspBck(enr::Float64, tmp::Float64)::ComplexF64
...
"""
function siEnrGap(tmp::Float64)::Float64 
...
Kelvin. 
"""
function itrnV(tmp::Float64)::Float64 
...
Kelvin. 
"""
function itrnC(tmp::Float64)::Float64 
...
function acpCcn(enrFrm::Float64, tmp::Float64, acp::dptDsc)::Float64
...
"""
function frmZero(enrFrm::Float64, tmp::Float64, dnr::dptDsc, acp::dptDsc)::Float64
